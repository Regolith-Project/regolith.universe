...
from regolith_planner.tour import (
    LEG_MAX_M,
    LEG_MIN_M,
    MAX_RANGE_M,
    MIN_SEPARATION_M,
...
def test_the_same_seed_gives_the_same_route():
    ...
    grid = _scatter_obstacles(_grid())
    assert (plan_tour(grid, RES, ORIGIN, ORIGIN, seed=42)["waypoints"]
...
def test_clearance_measures_the_tightest_pinch_not_the_average():
    ...
    from regolith_planner.tour import CLEARANCE_SEARCH_CELLS, path_clearance_cells
